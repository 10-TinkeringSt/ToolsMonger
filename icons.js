...
const TOOL_ICONS = {
  ...
  // Balance / comparison / weighing tools
  panBalance: `
    <line x1="50" y1="14" x2="50" y2="80" />
    <line x1="30" y1="88" x2="70" y2="88" />
    <line x1="18" y1="26" x2="82" y2="26" />
    <line x1="18" y1="26" x2="18" y2="46" />
    <line x1="82" y1="26" x2="82" y2="46" />
    <path d="M8 46 a10 10 0 0 0 20 0 Z" />
    <path d="M72 46 a10 10 0 0 0 20 0 Z" />
    <circle cx="50" cy="14" r="4" />
  `,

  // Card-suit cube (isometric box, only visible edges drawn)
  cardCube: `
    <path d="M50,12 L82,32 L82,73 L50,92 L18,73 L18,32 Z
             M50,51 L82,32
             M50,51 L18,32
             M50,51 L50,92" />
    <path d="M50,26 C48,29 44,30 44,34 C44,36.5 46.2,38 48,37 C48.3,38.5 49,40 50,40
             C51,40 51.7,38.5 52,37 C53.8,38 56,36.5 56,34 C56,30 52,29 50,26 Z"
          fill="#000" stroke="none" />
    <path d="M66,53 C63.5,55.5 63.5,58.5 66,59.5 C63.8,60 62,61.8 62,64 C62,66.5 64.5,68 67,66.5
             C66.5,68.5 65.5,70 64.3,71 L67.7,71 C66.5,70 65.5,68.5 65,66.5
             C67.5,68 70,66.5 70,64 C70,61.8 68.2,60 66,59.5 C68.5,58.5 68.5,55.5 66,53 Z"
          fill="#000" stroke="none" />
    <polygon points="34,53 39,61 34,69 29,61" fill="#000" stroke="none" />
  `
